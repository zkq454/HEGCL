...
if __name__ == '__main__':
    ...
    parser.add_argument('--svd_q', default=25, type=int,
                    help='svd rank')    
    
    # The CL setting
    parser.add_argument('--ucl_temp', type=float, default=0.9, help="temperature required by ucl loss")
    parser.add_argument('--wcl_temp', type=float, default=0.9, help="temperature required by wcl loss")
    parser.add_argument('--pncl_temp', type=float, default=0.9, help="temperature required by pncl loss")
    parser.add_argument('--para', type=float, default=0.5, help="pos-neg feature enhance para")
    parser.add_argument('--alpha', type=float, default=0.45, help="control unsupervised contrastive learning")
    parser.add_argument('--beta', type=float, default=0.45, help="control weakly-supervised contrastive learning")
    parser.add_argument('--theta', type=float, default=1, help="control supervised cross entropy")
    parser.add_argument('--newloss', type=float, default=0.1, help="control pos-neg contrastive learning")
