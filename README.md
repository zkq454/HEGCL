...
```
    Zhang K, Liu X, Zhang J, et al. Heterogeneous multiviews-based efficient graph contrastive learning model for short text classification. Knowledge-Based Systems, 2025, 327: 114121.
```
